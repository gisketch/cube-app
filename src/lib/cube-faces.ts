  ...
  for (let t = 0; t < times; t++) {
    switch (face) {
      case 'U': {
        ...
        result.F[0] = result.R[0]
        result.F[1] = result.R[1]
        result.F[2] = result.R[2]
        result.R[0] = result.B[0]
        result.R[1] = result.B[1]
        result.R[2] = result.B[2]
        result.B[0] = result.L[0]
        result.B[1] = result.L[1]
        result.B[2] = result.L[2]
        result.L[0] = temp[0]
        result.L[1] = temp[1]
        result.L[2] = temp[2]
        break
      ...
      case 'D': {
        ...
        result.F[6] = result.L[6]
        result.F[7] = result.L[7]
        result.F[8] = result.L[8]
        result.L[6] = result.B[6]
        result.L[7] = result.B[7]
        result.L[8] = result.B[8]
        result.B[6] = result.R[6]
        result.B[7] = result.R[7]
        result.B[8] = result.R[8]
        result.R[6] = temp[0]
        result.R[7] = temp[1]
        result.R[8] = temp[2]
        break
      ...
      case 'F': {
        ...
        result.U[6] = result.L[8]
        result.U[7] = result.L[5]
        result.U[8] = result.L[2]
        result.L[2] = result.D[0]
        result.L[5] = result.D[1]
        result.L[8] = result.D[2]
        result.D[0] = result.R[6]
        result.D[1] = result.R[3]
        result.D[2] = result.R[0]
        result.R[0] = temp[0]
        result.R[3] = temp[1]
        result.R[6] = temp[2]
        break
      ...
      case 'B': {
        ...
        result.U[0] = result.R[2]
        result.U[1] = result.R[5]
        result.U[2] = result.R[8]
        result.R[2] = result.D[8]
        result.R[5] = result.D[7]
        result.R[8] = result.D[6]
        result.D[6] = result.L[0]
        result.D[7] = result.L[3]
        result.D[8] = result.L[6]
        result.L[0] = temp[2]
        result.L[3] = temp[1]
        result.L[6] = temp[0]
        break
      ...
      case 'L': {
        ...
        result.U[0] = result.B[8]
        result.U[3] = result.B[5]
        result.U[6] = result.B[2]
        result.B[2] = result.D[6]
        result.B[5] = result.D[3]
        result.B[8] = result.D[0]
        result.D[0] = result.F[0]
        result.D[3] = result.F[3]
        result.D[6] = result.F[6]
        result.F[0] = temp[0]
        result.F[3] = temp[1]
        result.F[6] = temp[2]
        break
      ...
      case 'R': {
        ...
        result.U[2] = result.F[2]
        result.U[5] = result.F[5]
        result.U[8] = result.F[8]
        result.F[2] = result.D[2]
        result.F[5] = result.D[5]
        result.F[8] = result.D[8]
        result.D[2] = result.B[6]
        result.D[5] = result.B[3]
        result.D[8] = result.B[0]
        result.B[0] = temp[2]
        result.B[3] = temp[1]
        result.B[6] = temp[0]
        break
